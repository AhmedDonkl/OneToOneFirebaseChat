...
import com.androidtech.instar.Activities.ConversionActivity;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        User user = userItems.get(cardViewHolder.getAdapterPosition());
            ...
            if(user.getProfile_picture_thumbnail()!=null)
                GlideUtil.loadProfileIcon(user.getProfile_picture_thumbnail(),cardViewHolder.userImage);
        else
                GlideUtil.loadProfileIcon("",cardViewHolder.userImage);

            if(user.getFull_name()!=null)
                cardViewHolder.userFullName.setText(user.getFull_name());

            if(user.getUser_name()!=null)
                cardViewHolder.userName.setText("@"+user.getUser_name());

        if(user.getLast_message()!=null){

            cardViewHolder.userName.setVisibility(View.GONE);
