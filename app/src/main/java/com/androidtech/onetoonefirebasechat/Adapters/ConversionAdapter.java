...
import com.androidtech.instar.Models.Message;
...
import com.androidtech.instar.Utils.SharedPrefUtilities;
...
public class ConversionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(message.getSenderUid().equals(FirebaseUtil.getCurrentUserId())){//iam sender show my data
            userImage = mSharedPrefUtilities.getUserImageThumbnail();
        }else{//show image of another user
            userImage = chattingUser.getProfile_picture_thumbnail();
        }

        if(userImage!=null)
            GlideUtil.loadProfileIcon(userImage,cardViewHolder.userImage);
